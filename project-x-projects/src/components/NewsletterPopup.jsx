...
const STORAGE_KEY = "pxp_newsletter_popup_v1";
...
export default function NewsletterPopup() {
  ...
  useEffect(() => {
    ...
    if (stored?.state === "dismissed" || stored?.state === "subscribed") return;

    const t = setTimeout(() => setOpen(true), 1200); // small delay feels nicer
